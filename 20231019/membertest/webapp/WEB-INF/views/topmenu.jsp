...
| <a href="<%=contextPath%>/member/join">회원가입</a> | <a href="<%=contextPath%>/member/login">로그인</a>
 ...
 | <a href="<%=contextPath%>/member/list">회원목록</a>
<c:if test="${id != null}">
| <a href="<%=contextPath%>/member/update">회원정보수정</a> | <a href="<%=contextPath%>/member/logout">로그아웃</a> | <a href="#" onclick="deleteCheck();">회원탈퇴</a>
</c:if>
</h3>
<hr>
</body>
